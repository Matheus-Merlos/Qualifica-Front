...
export default function Login() {
  ...
  async function handleLoginSubmit(event) {
    ...
    const response = await axios.post(
      "https://api.test.qualificamais.app.br/user/login",
      {
        email: loginEmail,
    ...
    <div className="container">
      ...
      <div className="form-box">
        ...
        <div className="tab-buttons">
          <button className="tab active" onClick={() => showForm("login")}>
            Login
          </button>
          <button className="tab" onClick={() => showForm("cadastro")}>
            Cadastro
          </button>
        </div>
        ...
        >
          ...
          <label className="checkbox">
            <input type="checkbox" className="input-checkbox" /> Lembrar meu
            login
          </label>
