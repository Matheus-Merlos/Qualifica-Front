  ...
  return (
    <>
      <header className="top-bar">
        <div className="left">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 150" className="logo">
      ...
      <main className="course-container">
        ...
        <div className="main-right">
          ...
          <div className="capitulos">
            <h3>Capítulos</h3>
            <div className="lista">
              <div className="card"><div className="left"><img src="/apple.png" alt="Imagem do Capítulo" /> <div className="text"><h3>Capítulo 1</h3> <p>Introdução </p></div></div> <h3>05:43</h3></div>
              <div className="card"><div className="left"><img src="/apple.png" alt="Imagem do Capítulo" /> <div className="text"><h3>Capítulo 2</h3> <p>Introdução </p></div></div> <h3>05:43</h3></div>
              <div className="card"><div className="left"><img src="/apple.png" alt="Imagem do Capítulo" /> <div className="text"><h3>Capítulo 3</h3> <p>Introdução </p></div></div> <h3>05:43</h3></div>
              <div className="card"><div className="left"><img src="/apple.png" alt="Imagem do Capítulo" /> <div className="text"><h3>Capítulo 4</h3> <p>Introdução </p></div></div> <h3>05:43</h3></div>
              <div className="card"><div className="left"><img src="/apple.png" alt="Imagem do Capítulo" /> <div className="text"><h3>Capítulo 5</h3> <p>Introdução </p></div></div> <h3>05:43</h3></div>
              <div className="card"><div className="left"><img src="/apple.png" alt="Imagem do Capítulo" /> <div className="text"><h3>Capítulo 6</h3> <p>Introdução </p></div></div> <h3>05:43</h3></div>
              <div className="card"><div className="left"><img src="/apple.png" alt="Imagem do Capítulo" /> <div className="text"><h3>Capítulo 7</h3> <p>Introdução </p></div></div> <h3>05:43</h3></div>
              <div className="card"><div className="left"><img src="/apple.png" alt="Imagem do Capítulo" /> <div className="text"><h3>Capítulo 8</h3> <p>Introdução </p></div></div> <h3>05:43</h3></div>
              <div className="card"><div className="left"><img src="/apple.png" alt="Imagem do Capítulo" /> <div className="text"><h3>Capítulo 9</h3> <p>Introdução </p></div></div> <h3>05:43</h3></div>
              <div className="card"><div className="left"><img src="/apple.png" alt="Imagem do Capítulo" /> <div className="text"><h3>Capítulo 10</h3> <p>Introdução </p></div></div> <h3>05:43</h3></div>
              <div className="card"><div className="left"><img src="/apple.png" alt="Imagem do Capítulo" /> <div className="text"><h3>Capítulo 11</h3> <p>Introdução </p></div></div> <h3>05:43</h3></div>
              <div className="card"><div className="left"><img src="/apple.png" alt="Imagem do Capítulo" /> <div className="text"><h3>Capítulo 12</h3> <p>Introdução </p></div></div> <h3>05:43</h3></div>
              <div className="card"><div className="left"><img src="/apple.png" alt="Imagem do Capítulo" /> <div className="text"><h3>Capítulo 13</h3> <p>Introdução </p></div></div> <h3>05:43</h3></div>
              <div className="card"><div className="left"><img src="/apple.png" alt="Imagem do Capítulo" /> <div className="text"><h3>Capítulo 14</h3> <p>Introdução </p></div></div> <h3>05:43</h3></div>
              <div className="card"><div className="left"><img src="/apple.png" alt="Imagem do Capítulo" /> <div className="text"><h3>Capítulo 15</h3> <p>Introdução </p></div></div> <h3>05:43</h3></div>
              <div className="card"><div className="left"><img src="/apple.png" alt="Imagem do Capítulo" /> <div className="text"><h3>Capítulo 16</h3> <p>Introdução </p></div></div> <h3>05:43</h3></div>
              <div className="card"><div className="left"><img src="/apple.png" alt="Imagem do Capítulo" /> <div className="text"><h3>Capítulo 17</h3> <p>Introdução </p></div></div> <h3>05:43</h3></div>
              <div className="card"><div className="left"><img src="/apple.png" alt="Imagem do Capítulo" /> <div className="text"><h3>Capítulo 18</h3> <p>Introdução </p></div></div> <h3>05:43</h3></div>
              <div className="card"><div className="left"><img src="/apple.png" alt="Imagem do Capítulo" /> <div className="text"><h3>Capítulo 19</h3> <p>Introdução </p></div></div> <h3>05:43</h3></div>
              <div className="card"><div className="left"><img src="/apple.png" alt="Imagem do Capítulo" /> <div className="text"><h3>Capítulo 20</h3> <p>Introdução </p></div></div> <h3>05:43</h3></div>
              <div className="card"><div className="left"><img src="/apple.png" alt="Imagem do Capítulo" /> <div className="text"><h3>Capítulo 21</h3> <p>Introdução </p></div></div> <h3>05:43</h3></div>
            </div>
          </div>
        </div>
      </main>
