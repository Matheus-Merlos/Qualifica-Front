    ...
    export default function Login() {
        function showForm(type) {
            ...
            Object.keys(forms).forEach((key) => {
                ...
                tabs[key === "login" ? 0 : 1].classList.toggle(
                    "active",
                    key === type
                );
            });
            ...
            <div className="container">
                ...
                <div className="form-box">
                    ...
                    >
                        ...
                        <div className="social-buttons">
                            <button className="google">
                                <img src="/google.png" alt="Google" /> Entrar com
                                Google
                            </button>
                            <button type="button" className="apple">
                                <img src="/apple.png" alt="Apple" /> Entrar com
                                Apple
                            </button>
                        </div>
                    </form>
                    ...
                    <form id="cadastro-form" className={`form`}>
                        ...
                        <label htmlFor="cadastro-confirm-password">
                            Confirmar senha
                        </label>
                        <input
                            type="password"
